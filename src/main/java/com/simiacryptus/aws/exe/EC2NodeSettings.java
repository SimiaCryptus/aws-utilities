...
public class EC2NodeSettings {
  ...
  public static final String AMI_AMAZON_DEEP_LEARNING = com.simiacryptus.ref.wrappers.RefSystem
      .getProperty("AMI_AMAZON_DEEP_LEARNING", AMI_AMAZON_DEEP_LEARNING());
  public static final String AMI_AMAZON_LINUX = com.simiacryptus.ref.wrappers.RefSystem.getProperty("AMI_AMAZON_LINUX",
      AMI_AMAZON_LINUX());
